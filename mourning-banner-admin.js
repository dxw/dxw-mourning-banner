...
jQuery(document).ready(function ($) {
    ...
    // Build html.
    var banner = '<div class="mourning_banner_container"><div class="mourning_banner_wrap"><div class="mourning_banner">' + mourning_banner_vars.banner_message + '</div></div></div>';
